#NOTE: If/Else conditions are used to decide to do something based on a condition being true or false
...
#Compare the objects, not if they are equale, but if they are actually the same object, with the same memory location:
